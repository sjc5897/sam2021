...
CREATE TABLE submission(id INT PRIMARY KEY AUTO_INCREMENT, author_contact varchar(255) null, format varchar(255) null, title varchar(255) null, version varchar(255) null, constraint submission_id_unidex unique(id),state varchar(255)))